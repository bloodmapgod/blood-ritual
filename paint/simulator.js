var Simulator = (function () {
    ...
    function Simulator (wgl, shaderSources, resolutionWidth, resolutionHeight) {
        ...
        this.splatProgram = wgl.createProgram(
            shaderSources['paint/shaders/splat.vert'], shaderSources['paint/shaders/splat.frag']);

        this.velocitySplatProgram = wgl.createProgram(
            '#define VELOCITY \n' + shaderSources['paint/shaders/splat.vert'], '#define VELOCITY \n' + shaderSources['paint/shaders/splat.frag']);

        this.advectProgram = wgl.createProgram(
            shaderSources['paint/shaders/fullscreen.vert'], shaderSources['paint/shaders/advect.frag']);

        this.divergenceProgram = wgl.createProgram(
            shaderSources['paint/shaders/fullscreen.vert'], shaderSources['paint/shaders/divergence.frag']);

        this.jacobiProgram = wgl.createProgram(
            shaderSources['paint/shaders/fullscreen.vert'], shaderSources['paint/shaders/jacobi.frag']);

        this.subtractProgram = wgl.createProgram(
            shaderSources['paint/shaders/fullscreen.vert'], shaderSources['paint/shaders/subtract.frag']);

        this.copyProgram = wgl.createProgram(
            shaderSources['paint/shaders/fullscreen.vert'], shaderSources['paint/shaders/output.frag']);

        this.resizeProgram = wgl.createProgram(
            shaderSources['paint/shaders/fullscreen.vert'], shaderSources['paint/shaders/resize.frag']);

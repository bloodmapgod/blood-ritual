var Brush = (function () {
    ...
    function Brush (wgl, shaderSources, maxBristleCount) {
        ...
        this.projectProgram = wgl.createProgram(
            shaderSources['paint/shaders/fullscreen.vert'], shaderSources['paint/shaders/project.frag']);

        this.distanceConstraintProgram = wgl.createProgram(
            shaderSources['paint/shaders/fullscreen.vert'], shaderSources['paint/shaders/distanceconstraint.frag']);

        this.planeConstraintProgram = wgl.createProgram(
            shaderSources['paint/shaders/fullscreen.vert'], shaderSources['paint/shaders/planeconstraint.frag']);

        this.bendingConstraintProgram = wgl.createProgram(
            shaderSources['paint/shaders/fullscreen.vert'], shaderSources['paint/shaders/bendingconstraint.frag']);

        this.setBristlesProgram = wgl.createProgram(
            shaderSources['paint/shaders/fullscreen.vert'], shaderSources['paint/shaders/setbristles.frag']);

        this.updateVelocityProgram = wgl.createProgram(
            shaderSources['paint/shaders/fullscreen.vert'], shaderSources['paint/shaders/updatevelocity.frag']);
